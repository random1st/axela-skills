...
- **Upstream license**: MIT, © Jesse Vincent — see LICENSE in this folder (copied verbatim from the source repository).
...
- **Scanner**: SkillSpector caution, score 7, static analysis only (no file contents were sent to any model).
